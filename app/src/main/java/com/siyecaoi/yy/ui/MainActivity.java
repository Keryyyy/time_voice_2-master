...
//    FindFragment findFragment;
    ...
    public void switchDrawer(){
        if (drawer_main.isDrawerOpen(GravityCompat.END))
            drawer_main.closeDrawer(GravityCompat.END);
        else
            drawer_main.openDrawer(GravityCompat.END);
    }
...
//        setfrag();
    ...
    private void initShared(UserBean.DataBean dataBean) {
        ...
        SharedPreferenceUtils.put(this, Const.User.HAVE_NUMBER_PORT, dataBean.getIsRandomNumber());
    }
...
//        }
        ...
        ImageUtils.loadUri(ivRoomshowMain, Const.RoomImg);
...
//    }
    ...
    @OnClick({R.id.tv_home, R.id.tv_find, R.id.tv_message, R.id.tv_mine,R.id.rl_about_mine,
            R.id.iv_panit_mine, R.id.rl_mywallet_mine, R.id.rl_store_mine, R.id.rl_setting_mine,
            R.id.rl_topup_real, R.id.rl_grade_mine, R.id.iv_closeroom_main, R.id.rl_room_main
    })
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_about_mine:
                ...
                bundle1.putInt(Const.ShowIntent.TYPE, 14);
                bundle1.putString(Const.ShowIntent.TITLE, "关于我们");
