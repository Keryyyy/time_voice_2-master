...
public class SendOtherFragment extends MyBaseFragment {
    ...
    private void showMyDialog(MyattentionBean.DataEntity dataEntity, int position) {
        ...
        ForegroundColorSpan colorSpan = new ForegroundColorSpan(Color.parseColor("#81F6B4"));
        ForegroundColorSpan colorSpan2 = new ForegroundColorSpan(Color.parseColor("#81F6B4"));
        ...
        ForegroundColorSpan colorSpan1 = new ForegroundColorSpan(Color.parseColor("#81F6B4"));
