...
//                        showMybottomDialog(dataEntity.getId(), dataEntity.getName(),dataEntity.getGold());
    ...
    private void showMyDialog(int id, String nameShow,int gold) {
        ...
        ForegroundColorSpan colorSpan = new ForegroundColorSpan(Color.parseColor("#46C4FF"));
        ...
        ForegroundColorSpan colorSpan1 = new ForegroundColorSpan(Color.parseColor("#46C4FF"));
