...
public class RoomRankFragment extends BaseFragment {
    ...
    protected int getContentViewLayoutID() {
        return R.layout.fragment_rank_recyclerview;
    }
    ...
    protected void onFirstVisibleToUser() {
        ...
        viewHolder.tvOffset0.setTextColor(textColor);
        viewHolder.tvOffset1.setTextColor(textColor);
        viewHolder.tvOffset2.setTextColor(textColor);
        adapter = new RoomRankAdapter(users, type, userToken, userRoomType,textColorItem);
            ...
            public void success(String responseString) {
                ...
                if (baseBean.getCode() == Api.SUCCESS) {
                    ...
                    if (data.isEmpty()) {
                        ...
                        viewHolder.tvOffset0.setVisibility(View.INVISIBLE);
...
//                        viewHolder.tv3rd.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                        ...
                        if (userToken == data.get(0).getId()||userRoomType == 1 || userRoomType == 2) {
                            viewHolder.tvOffset0.setVisibility(View.VISIBLE);
                            String s1 = "" + data.get(0).getNum();
                            viewHolder.tvOffset0.setText(s1);
                        }
                        else {
                            viewHolder.iv_top1.setText("");
                            viewHolder.tvOffset0.setVisibility(View.INVISIBLE);
