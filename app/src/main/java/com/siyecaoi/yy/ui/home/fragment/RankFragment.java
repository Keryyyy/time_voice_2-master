...
public class RankFragment extends BaseFragment {
    ...
    protected void onFirstVisibleToUser() {
        ...
        if (type == 1) {// 1土豪榜
            iv_bg.setBackgroundResource(R.drawable.bg_rich);
            ...
            textColor = Color.parseColor("#81F6B4");
            textColorItem = Color.parseColor("#81F6B4");
        } else {//2魅力榜
            iv_bg.setBackgroundResource(R.drawable.bg_att);
            ...
            textColor = Color.parseColor("#AFF1FF");
            textColorItem = Color.parseColor("#9063D6");

        }
        adapter = new RankAdapter(textColorItem,users, type, userToken);
        ...
        HttpManager.getInstance().post(Api.HOME_RANK, map, new MyObserver(this) {
            ...
            public void success(String responseString) {
                ...
                if (baseBean.getCode() == Api.SUCCESS) {
                    ...
                    if (myData!=null){
                        ivMy.setImageURI(myData.getImgTx());
                        tvMy.setText(myData.getNickname());
                        tvMyNum.setText("ID:"+myData.getUsercoding());
                        tvMyNum.setCompoundDrawablesWithIntrinsicBounds(myData.getIsliang()==1?R.drawable.liang_id:0,
                                0,0,0);
                        tvMyRank.setText(myData.rankNum == 0?"未上榜":String.format(Locale.CHINA,"%02d",myData.rankNum));
                        tvMyRank.setTextSize(TypedValue.COMPLEX_UNIT_SP,myData.rankNum == 0?10:24);
                        tvMyRank.setTextColor(Color.parseColor(myData.rankNum == 0?"#9FA3B0":"#AFF1FF"));
                    }
