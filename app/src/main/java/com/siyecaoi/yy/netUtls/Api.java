...
public class Api {
     ...
     * 超级幸运星 ---页面数据接口
     */
    public static String raiseActivityPageData = "/fx/raiseActivityPageData";


    /**
     * 超级幸运星 ---参加
     */
    public static String raiseActivitySign = "/fx/raiseActivitySign";
    ...
    //获取随机数
    public static String randomNumber = "fx/randomNumber";

    //设置随机数
    public static String setRandomNumber = "fx/setRandomNumber";
     ...
     * rid	是	String	房间id
     */
    public static String GetLottery = "Lottery/GetLottery";
    public static String GetLottery2 = "Lottery/GetLottery2";//钻石蛋
    /**
     * 获取 宝箱信息
     */
     ...
     * uid 用户ID    pageNum 页数    pageSize 每页大小
     */
    public static String shuttleTime = "fx/shuttleTime";

    /**
     *时光穿梭个数
     */
    public static String shuttleTimeNum = "fx/shuttleTimeNum";
    /**
     *
     */
