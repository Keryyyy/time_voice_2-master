...
public class MyEngineEventHandler {
    ...
    final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onMicrophoneEnabled(boolean enabled) {
            ...
            LogUtils.d(LogUtils.TAG, "麦克风状态已改变" + enabled);
            it = mEventHandlerList.keySet().iterator();
            while (it.hasNext()) {
                AGEventHandler handler = it.next();
                handler.onExtraCallback(AGEventHandler.EVENT_TYPE_ON_MIC, enabled);
            }
        }
...
//        }
        ...
        public void onConnectionInterrupted() {
            ...
            while (it.hasNext()) {
                AGEventHandler handler = it.next();
                handler.onExtraCallback(AGEventHandler.EVENT_TYPE_ON_APP_ERROR);
            }
        }
