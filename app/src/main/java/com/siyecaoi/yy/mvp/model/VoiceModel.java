...
public class VoiceModel implements BaseModel {
     ...
     * @param observer
     */
    public void getRandomNumber(int uid, Observer<ResponseBody> observer) {
        HashMap<String, Object> map = HttpManager.getInstance().getMap();
        map.put("uid", uid);
        HttpManager.getInstance().post(Api.randomNumber, map, observer);
    }
     ...
     * @param observer
     */
    public void setRandomNumber(int uid, String randomNumber,Observer<ResponseBody> observer) {
        HashMap<String, Object> map = HttpManager.getInstance().getMap();
        map.put("uid", uid);
        map.put("numberStr", randomNumber);
        HttpManager.getInstance().post(Api.setRandomNumber, map, observer);
    }
