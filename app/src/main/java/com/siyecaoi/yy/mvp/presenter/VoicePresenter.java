...
public class VoicePresenter extends MyBasePresenter<VoiceView, VoiceModel> {
    ...
    public void getRandomNumber(int uid, Observer<ResponseBody> observer) {
        getModel().getRandomNumber(uid,observer);
    }
     ...
     * @param uid
     */
    public void setRandomNumber(int uid, String number,Observer<ResponseBody> observer) {
        getModel().setRandomNumber(uid,number,observer);
    }
...
//                    getView().onCallbackShow(responseString, Const.IntShow.TWO);
    ...
    public void getSendAllGift(String rid, int uid, int buid) {
