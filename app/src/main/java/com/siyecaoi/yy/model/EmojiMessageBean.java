...
public class EmojiMessageBean {
    ...
    public static class DataBean {
        ...
        private ArrayList<Integer> randomNumbers;//随机数

        public DataBean(int grade, int charm, int emojiCode, String avatar, String name, int uid, int numberShow,String imageName,ArrayList<Integer> randomNumbers) {
            this.grade = grade;
            this.charm = charm;
            this.avatar = avatar;
